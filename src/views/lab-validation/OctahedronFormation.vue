  ...
  <Notebook>
    ...
    <template #body>
      <SingleColumn>
        ...
        <template #body>
          <p>
            ...
            enzymes were attached to the liposome structure. The DNA origami template structure was
            an octahedron-type endoskeleton based on “Virus-Inspired Membrane Encapsulation of DNA
            Nanostructures To Achieve In Vivo Stability” (Perrault et al., 2014). The DNA
            endoskeleton was used as a design strategy to encapsulate a lipid membrane over the DNA
            endoskeleton to ensure high structural support. A software called CadNano, which runs on
            python, was used to design our structures. caDNAno uses 2D representations to design 3D
            DNA origami structures. Previous UBC BIOMOD teams have developed python scripts to check
            for issues that may arise, including DNA getting stuck in local energy minima during the
            folding process as well as the relative length of staple strands affecting the annealing
            process. The workflow started with determining the shape of the structure and the helix
            layout, followed by computational design and testing the structure using online
            simulation tools such as mrDNA and Cando. After verifying our structures
            computationally, the structures are formed in the lab using oligo annealing protocols
            and verified using a variety of imaging techniques.
          </p>
        </template>
      </SingleColumn>
      ...
      <SingleColumn>
        ...
        <template #body>
          <p>
            To prepare a 3D octahedron-like structure using sourced scaffold, staple sequences,
            reagents and a temperature gradient. The purpose is to create a modular enzymosome. To
            achieve this, an endo structure is designed where the enzymosome would be outside the
            DNA scaffolding.The DNA scaffolding would provide structural support to ensure a
            constant shape for the liposome.
          </p>
        </template>
      </SingleColumn>
      ...
      <SingleColumn>
        ...
        <template #body>
          <p>PCR using Thermoramp cycling and gel electrophoresis.</p>
        </template>
      </SingleColumn>

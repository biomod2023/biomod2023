  ...
  <Notebook>
    ...
    <template #body>
      ...
      <SingleColumn>
        ...
        <template #body>
          <p>
            This study conducts molecular docking and interaction assessments, with a specific focus
            ...
            governing enzyme-Maleimide binding. The outcomes of these simulations will provide
            critical insights into the feasibility of enzymosome design and the potential for
            precise enzyme delivery mechanisms.
          </p>
        </template>
      </SingleColumn>
      ...
      <SingleColumn>
        ...
        <template #body>
          ...
          <Section>
            ...
            <template #content>
              <p>
                The chemical structure (SMILES) of Maleimide was obtained from PubChem (PubChem,
                2021). To facilitate molecular docking, we utilized the MarvinSketch software to
                generate a clean 3D representation of the ligand (Figure 4) and subsequently
                produced a MOL file, as it is the preferred file format for docking studies.
              </p>
              <br />
              <CaptionedGraphics>
                <template #graphics>
                  <img
                    :src="figure2"
                    alt="Figure 2. 3D representation of Maleimide in Pymol. The SMILES form of the molecule was imported to MarvinSketch and cleaned in 3D to generate a MOL file."
                  />
                </template>
                <template #caption>
                  Figure 2. 3D representation of Maleimide in Pymol. The SMILES form of the molecule
                  was imported to MarvinSketch and cleaned in 3D to generate a MOL file.
                </template>
              </CaptionedGraphics>
            </template>
          </Section>
          ...
          <Section>
            ...
            <template #content>
              <p>
                We employed the CB Dock online computational tool to execute molecular docking
                simulations. The three-dimensional (3D) structure of a protein and a ligand,
                predicting their binding sites and affinity is a key task for computer-aided
                simulations. CB Dock predicts binding sites of a given protein, calculates the
                centers and sizes with a novel curvature-based cavity detection approach, and
                performs docking using AutoDock Vina (Priya et al., 2022).
                <br />
                <br />
            ...
            <template #content>
              ...
              <section>
                ...
                <CaptionedGraphics>
                  ...
                  <template #caption>
                    Figure 5. Cartoon representation of rhDNase I depicting the active site of the
                    enzyme. The active site residues are shown as beige sticks where oxygen and
                    nitrogen atoms are in red and blue, respectively. The Mg2+ ion is shown as a
                    cyan sphere and Ca2+ ions are shown as grey spheres. The phosphate ion is shown
                    in sticks with the phosphorus atom in orange. The figure was made using PyMOL
                    using accession code 4AWN for rhDNase I (Parsiegla et al. 2012).
                  </template>
                </CaptionedGraphics>
              </section>
            </template>
      ...
      <SingleColumn>
        ...
        <template #body>
          <div class="pl-6 -indent-6">
            <p>
              Lazarus, R. A., & Wagener, J. S. (2019). Recombinant Human Deoxyribonuclease I.
              Pharmaceutical Biotechnology, 471–488.
              <a href="https://doi.org/10.1007/978-3-030-00710-2_22"
                >https://doi.org/10.1007/978-3-030-00710-2_22</a
              >
            </p>
            <p>
              Parsiegla, G., Noguere, C., Santell, L., Lazarus, R. A., & Bourne, Y. (2012). The
              Structure of Human DNase I Bound to Magnesium and Phosphate Ions Points to a Catalytic
              Mechanism Common to Members of the DNase I-like Superfamily. Biochemistry, 51(51),
              10250–10258.
              <a href="https://doi.org/10.1021/bi300873f">https://doi.org/10.1021/bi300873f</a>
            </p>
            <p>
              Priya, R., Vinoth, M., & Radha, M. (2022). In-silico analysis of polycystic kidney
              disease using molecular docking and virtual screening. International Journal of
              Advanced Research in Biological Sciences, 9(5), 98-107.
              <a href="http://doi.org/10.22192/ijarbs.2022.09.05.01.011"
                >http://doi.org/10.22192/ijarbs.2022.09.05.01.011</a
              >
            </p>
            <p>
              PubChem. (2021). Maleimide Chemical Structure. U.S. National Library of Medicine.
              <a href="https://pubchem.ncbi.nlm.nih.gov/compound/10935#section=InChIKey"
                >https://pubchem.ncbi.nlm.nih.gov/compound/10935#section=InChIKey</a
              >
            </p>
            <p>
              Sadybekov, A. V., & Katritch, V. (2023). Computational Approaches Streamlining Drug
              Discovery. Nature, 616(7958), 673–685.
              <a href="https://doi.org/10.1038/s41586-023-05905-z"
                >https://doi.org/10.1038/s41586-023-05905-z</a
              >
            </p>
          </div>
        </template>
